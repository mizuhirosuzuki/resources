...
### Violence / Conflict
- [xSub: A New Portal for Cross-National Data on Sub-National Violence](https://sites.lsa.umich.edu/zhukov/wp-content/uploads/sites/140/2017/08/xSub_Aug2017.pdf)
...
- [African education reserach database by ESSA](https://essa-africa.org/AERD)
- [Open data sources compilation for Mexico by edublancas](https://github.com/edublancas/open-data-mexico)
- [International migration flows between each pair of countries (196x196 matrix)](https://science.sciencemag.org/content/suppl/2014/03/27/343.6178.1520.DC1)
...
- [Slave Trade Database](https://slavevoyages.org/)
- [Liquor and Cannabis Daily Sales in Washington](https://data.lcb.wa.gov/dataset/Dashboard-Usable-Sales-w-Weight-Daily/9wz2-qma2)
...
- [Open Data at the New York Philharmonic](https://archives.nyphil.org/index.php/open-data)
...
- [Visualizations That Really Work by Harvard Business Review](https://hbr.org/2016/06/visualizations-that-really-work)
- [ColorBrewer](https://colorbrewer2.org/#type=sequential&scheme=BuGn&n=3)
- [AEA's favorite data visualizations in 2016](https://www.aeaweb.org/research/top-data-visualizations-past-year-june-2017)
...
- [Hayao Miyazaki Picks His 50 Favorite Children’s Books](http://www.openculture.com/2017/05/hayao-miyazaki-picks-his-50-favorite-childrens-books.html)
- [International Movie List for Kids by Laura Schechter](https://aae.wisc.edu/lschechter/KidsMovies.pdf)
...
- [Practical tips for writing and publishing applied economics papers by Timothy Beatty and Jay Shimshack](https://static1.squarespace.com/static/55e8ab64e4b0b55649c4ab64/t/59d73b99f43b5586a0484a22/1507277732282/beatty_shimshack_applied_econ_papers.pdf)
- [Writing Tips for Ph.D. Students by John Cochrane](https://faculty.chicagobooth.edu/john.cochrane/teaching/papers/phd_paper_writing.pdf)
- [Twitter thread by Jeffrey Brown](https://twitter.com/IlliniBizDean/status/1029162543116443649)
...
- [AEA's Mentoring Reading Materials](https://www.aeaweb.org/about-aea/committees/cswep/mentoring/reading)
...
- [Econ papers about witches & witch trials (Twitter thread)](https://twitter.com/jenniferdoleac/status/1001792240476393472)
...
### General
- [Useful computational resources by Maximilian Kasy](https://maxkasy.github.io/home/computationlinks/)
- [20 Cheat Sheets: Python, ML, Data Science, R, and More](https://www.datasciencecentral.com/profiles/blogs/20-cheat-sheets-python-ml-data-science?utm_content=buffera54f8&utm_medium=social&utm_source=twitter.com&utm_campaign=buffer)
- [IPA's Best Practices for Data and Code Management](https://www.poverty-action.org/sites/default/files/publications/IPA's%20Best%20Practices%20for%20Data%20and%20Code%20Management_Nov2015.pdf)
- [Coding for Economists by Ljubica Ristovska](https://www.dropbox.com/s/vx53qtwake5wwpg/Coding_For_Econs_20190221.pdf?dl=0)
- [Data for Development Impact by World Bank DIME Analytics](https://github.com/worldbank/dime-data-handbook)
- [Checklist for Result Tables](https://dimewiki.worldbank.org/wiki/Checklist:_Submit_Table)
...
#### Useful commands
- [renamefrom and encodefrom](https://github.com/slhudson/rename-and-encode): ...
- [ritest: Randomization inference in stata](https://www.stata-journal.com/article.html?article=st0489)
- [ietoolkit by World Bank](https://github.com/worldbank/ietoolkit)
- [help undocumented](https://www.stata.com/help.cgi?undocumented)
- [wyoung for multiple hypothesis testing](https://www.nber.org/workplacewellness/s/wyoung.pdf)
- [binsreg for binscatter](https://sites.google.com/site/nppackages/binsreg/)
- coeflegend (see [this tweet](https://twitter.com/wsandholtz/status/1136697757589106688))
- [fre](https://ideas.repec.org/c/boc/bocode/s456835.html) and [fsum](https://ideas.repec.org/c/boc/bocode/s426501.html)
- group_lines for time series plots with many groups (see [this tweet](https://twitter.com/austinlwright/status/1263880542761746432))
- [wbopendata: Stata module to access World Bank databases](https://datahelpdesk.worldbank.org/knowledgebase/articles/889464-wbopendata-stata-module-to-access-world-bank-data)
...
- [How to write LaTeX table code within Stata (Twitter thread)](https://twitter.com/nomadj1s/status/1051112991393964032)
...
- [distances](https://github.com/fsavje/distances): "The distances package provides tools for constructing, manipulating and using distance metrics in R."
- [summarytools](https://cran.r-project.org/web/packages/summarytools/vignettes/Introduction.html): "summarytools provides a coherent set of functions centered on data exploration and simple reporting."
- [democracyData for democracy indices](https://xmarquez.github.io/democracyData/)
- [binsreg: Binscatter Estimation and Inference](https://cran.r-project.org/web/packages/binsreg/index.html)
- [tableone](https://cran.r-project.org/web/packages/tableone/vignettes/introduction.html): "The tableone package is an R package that eases the construction of "Table 1", i.e., patient baseline characteristics table commonly found in biomedical research papers."
- [multiwayvcov](https://cran.r-project.org/web/packages/multiwayvcov/multiwayvcov.pdf): "Exports two functions implementing multi-way clustering using the method suggested by Cameron, Gelbach, & Miller (2011) and cluster (or block) bootstrapping for estimating variance-covariance matrices"
- [estatapi: R Interface to e-Stat API](https://cran.r-project.org/web/packages/estatapi/index.html): "Provides an interface to e-Stat API, the one-stop service for official statistics of the Japanese government."
- [spmoran: Moran Eigenvector-Based Scalable Spatial Additive Mixed Modeling](https://cran.r-project.org/web/packages/spmoran/index.html) (used in spatial econometrics?)
- [hdm: High-Dimensional Metrics](https://cran.r-project.org/web/packages/hdm/index.html): "Implementation of selected high-dimensional statistical and econometric methods for estimation and inference."
...
- [Handling missing values with R](https://github.com/njtierney/user2018-missing-data-tutorial/blob/master/user-2018-tutorial-workbook.Rmd)
- [Some useful R tips (Twitter thread)](https://twitter.com/WeAreRLadies/status/1034801405213724672)
- [Econometrics in R's tidyverse](https://github.com/tyleransom/EconometricsLabs/blob/master/tidyRcheatsheet.pdf)
...
- [Making Stata tables smaller (fit on slide) in Beamer](http://www.hargaden.com/enda/making-stata-tables-smaller-fit-on-slide-in-beamer/)
- [Beamer poster template by tyleransom](https://github.com/tyleransom/beamer-poster-example)
- [Equation to LaTeX](https://mathpix.com/)
- [How I'm able to take notes in mathematics lectures using LaTeX and Vim](https://castel.dev/post/lecture-notes-1/#disqus_thread)
- [How to make econ figures with Tikz (Twitter thread)](https://twitter.com/Thevesh/status/1098554897136603136)
...
- [AI Prism](https://www.youtube.com/channel/UCTgM-VlXKuylPrZ_YGAJHOw/videos?sort=p&view=0&flow=grid&utm_content=buffer8d7dd&utm_medium=social&utm_source=twitter.com&utm_campaign=buffer)
- [Statistical Learning (lecture @ Stanford)](https://online.stanford.edu/courses/sohs-ystatslearning-statistical-learning)
- [Navigating ML](https://rheartpython.github.io/navigating-ml/)
- [Machine Learning Crash Course by Google](https://developers.google.com/machine-learning/crash-course/?utm_content=buffer9545c&utm_medium=social&utm_source=twitter.com&utm_campaign=buffer)
- [CS 294: Deep Reinforcement Learning (@ UC Berkeley)](http://rail.eecs.berkeley.edu/deeprlcourse-fa17/index.html)
...
- [Collection by John Holbein for courses on experimental design, especially in politics](https://www.dropbox.com/sh/j8yxxu2hdb4mtwy/AAC8x1VfwROiwGxMZUq9_ncva?dl=0)
- [CS267 -- Graph Algorithms @ Stanford](https://theory.stanford.edu/~virgi/cs267/)
- [Econ 2148: Advances in causality and foundations of machine learning (@ Harvard)](https://scholar.harvard.edu/kasy/classes/econ-2148-advances-causality-and-foundations-machine-learning?utm_content=buffer63ec1&utm_medium=social&utm_source=twitter.com&utm_campaign=buffer)
- [Econ 1126: Applied Econometrics (@ Harvard)](https://scholar.harvard.edu/kasy/classes/econ-1126-harvard-applied-econometrics)
- [Ec 2450B: Public Economics and Fiscal Policy II (@ Harvard)](https://scholar.harvard.edu/hendren/classes/public-economics-ii-2450b)
- [ECON 60650 : DESIGNING & ANALYZING EXPERIMENTS (@ Notre Dame)](https://www.dropbox.com/s/30l24982ky2hpi2/ECON60650_Syllabus_Spring_to%20share.pdf?dl=0)
...
- [Intra-African migration](https://openaccess.leidenuniv.nl/bitstream/handle/1887/54691/20170922-Africa-Migration-GECORRIGEERD-PRINT.pdf?sequence=4)
- [1880 Map of Telegraph Cable Routes](https://mapsontheweb.zoom-maps.com/post/174109799891/1880-map-of-telegraph-cable-routes)
- [Global Fishing Watch](https://globalfishingwatch.org/map/)
- [The Map of Mathematics](https://www.flickr.com/photos/95869671@N08/32264483720)

### Small tips
- [When you share link to a PDF file on Dropbox, ...](https://twitter.com/roozbeh52/status/999295206842421248)
- [Suits for Job Market Candidates (Twitter thread)](https://twitter.com/real_eric_ohrn/status/1043171487925133312)
...
- [Quantum Information Science](https://www.edx.org/course/quantum-information-science-i-part-1)
